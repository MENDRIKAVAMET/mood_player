...
/// duration) rather than the Track object itself - records have
...
final lyricsProvider = FutureProvider.family
    .autoDispose<LyricsResult, (String title, String artist, int? durationMs)>(
        (ref, key) async {
...
(String, String, int?) lyricsKeyFor(Track track) =>
